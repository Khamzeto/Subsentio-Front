...
export async function generateMetadata() {
  ...
  try {
    ...
    translations = { profile: { title: 'Recover Password | Subsentio' } }; // Значение по умолчанию
  }

  return {
    title: `${
      `${translations.forgotPassword.recoverPassword} | Subsentio` || 'Recover Password'
    }`, // Динамический заголовок с переводом и смайликом
  };
}
